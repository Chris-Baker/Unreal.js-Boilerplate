...
declare class JSTestGameModeBase extends GameModeBase { 
	static GetDefaultObject(): JSTestGameModeBase;
	static CreateDefaultSubobject(Name: string, Transient?: boolean, Required?: boolean, Abstract?: boolean): JSTestGameModeBase;
	static C(Other: UObject | any): JSTestGameModeBase;
}
